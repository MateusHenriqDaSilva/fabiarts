...
import { Product, ProductCategory } from '@/types'; // ← Importar ProductCategory
...
const mockProducts: Product[] = [
  ...
  // Produtos de Madeira - CATEGORIA CORRETA
  { id: 7, name: 'Cadeira Madeira', price: 299.90, category: 'madeira', image: '/madeira/madeira1.jpg', description: 'Cadeira rústica em madeira maciça' },
  { id: 8, name: 'Mesa Centro Madeira', price: 199.90, category: 'madeira', image: '/madeira/madeira2.jpg', description: 'Mesa de centro em madeira natural' },
  { id: 9, name: 'Prateleira Madeira', price: 129.90, category: 'madeira', image: '/madeira/madeira3.jpg', description: 'Prateleira decorativa em madeira' },
  { id: 10, name: 'Porta-chapéu Madeira', price: 159.90, category: 'madeira', image: '/madeira/madeira4.jpg', description: 'Cabideiro porta-chapéu em madeira' },
  { id: 11, name: 'Banco Madeira', price: 179.90, category: 'madeira', image: '/madeira/madeira5.jpg', description: 'Banco rústico em madeira' },
  { id: 12, name: 'Painel Madeira', price: 249.90, category: 'madeira', image: '/madeira/madeira6.jpg', description: 'Painel decorativo em madeira' },
  
  // Produtos de Mesa - DESCOMENTADOS E CORRIGIDOS
  ...
  { id: 16, name: 'Mesa Rústica', price: 799.90, category: 'mesa', image: '/mesa/mesa4.jpg', description: 'Mesa rústica em madeira maciça' },
...
export default function Home() {
  // CORRIGIDO: usar ProductCategory em vez do tipo literal
  const [activeCategory, setActiveCategory] = useState<ProductCategory>('madeira');
